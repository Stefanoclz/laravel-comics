...
<body>
    ...
    <main class="mainDetail">
        ...
        <div class="containerDetail">
            <img class="imgDetail" src={{ $lista['thumb'] }} alt="Comic">
            ...
            <div class="infoComic">
                ...
                <div class="description">
                    ...
                    <div class="infoPrice">
                        <div class="price">
                            <h5><span>U.S. Price: </span>{{ $lista['price'] }}</h5>
        ...
        <div class="detail">
            ...
            <div class="talent">
                ...
                <div class="det">
                    <h6>Art by:</h6>
                    <div>
                        @foreach($lista['artists'] as $artist)
                        <p><a href="">{{ $artist }}</a></p>
                        @endforeach
                    </div>
                </div>
                <div class="det">
                    <h6>Written by: </h6>
                    <div>
                        @foreach($lista['writers'] as $writer)
                        <p><a href="">{{ $writer }}</a></p>
                        @endforeach
                    </div>
                </div>
